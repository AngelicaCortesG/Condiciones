function calcular() {
    ...
    span = document.querySelector('span')
     ...
     if (select1.value == 9 && select2.value == 1 && select3.value == 1) {
        span = document.querySelector('span').textContent = 'Password 1 correcto'
    } else if (select1.value == 7 && select2.value == 1 && select3.value == 4) {
        span = document.querySelector('span').textContent = 'Password 2 correcto'
    } else {
        span = document.querySelector('span').textContent = 'Password incorrecto';
    }
}